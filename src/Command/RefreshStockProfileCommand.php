...
class RefreshStockProfileCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->addArgument('region',
                ...
                'The region of the company e.g. US for United States')
    ...
    {
        // 1. Ping Yahoo API and grab the response (a stock profile) ['statusCode' => $statusCode, 'content' =>
        // $someJsonContent]
        ...
        // 2. Use the stock profile to create a record if it doesn't exist
